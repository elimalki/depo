    ...
    if (!_user.equals("") && !_pass.equals("") && _to.length > 0 && !_from.equals("") &&
      ...
      Session session = Session.getInstance(props, new javax.mail.Authenticator() {
        protected PasswordAuthentication getPasswordAuthentication() {
          return new PasswordAuthentication("ptool8app@gmail.com", "taleng12");
        }
      });
...
// send email
      ...
      try {
        t.connect("smtp.gmail.com", "ptool8app@gmail.com", "taleng12");
  ...
  private Properties _setProperties() {
    ...
    //https://stackoverflow.com/questions/45649931/could-not-connect-to-smtp-host-smtp-gmail-com-port-465-response-1-why-465?rq=1
